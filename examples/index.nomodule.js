...
var e = Symbol("tag"); var s = Symbol("needsRender"); var i = function i(t) {
...
var _templateObject = taggedTemplateLiteral(['<style> p { color: firebrick } </style>'], ['<style> p { color: firebrick } </style>']);
var _templateObject2 = taggedTemplateLiteral(['\n      ', '\n      <p>Hello ', '</p>\n    '], ['\n      ', '\n      <p>Hello ', '</p>\n    ']);
var _templateObject3 = taggedTemplateLiteral(['<style> p { text-transform: uppercase } </style>'], ['<style> p { text-transform: uppercase } </style>']);

var HelloMessage = function (_GluonElement) {
  inherits(HelloMessage, _GluonElement);

  function HelloMessage() {
    classCallCheck(this, HelloMessage);
    return possibleConstructorReturn(this, (HelloMessage.__proto__ || Object.getPrototypeOf(HelloMessage)).apply(this, arguments));
  }

  createClass(HelloMessage, [{
    key: 'style',
    get: function get$$1() {
    ...
    key: 'template',
    get: function get$$1() {
      return html$1(_templateObject2, this.style, this.getAttribute('name'));
    }
  }]);
  return HelloMessage;
}(h);
...
var LoudMessage = function (_HelloMessage) {
  inherits(LoudMessage, _HelloMessage);

  function LoudMessage() {
    classCallCheck(this, LoudMessage);
    return possibleConstructorReturn(this, (LoudMessage.__proto__ || Object.getPrototypeOf(LoudMessage)).apply(this, arguments));
  }

  createClass(LoudMessage, [{
    key: 'style',
    get: function get$$1() {
      return html$1(_templateObject3);
    }
  }]);
  return LoudMessage;
}(HelloMessage);
