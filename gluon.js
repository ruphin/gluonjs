...
import{render,html}from'../lit-html/lit-html.js';export{html};export class GluonElement extends HTMLElement{constructor(){super();if('template'in this){this.attachShadow({mode:'open'});this.render();Promise.resolve().then(()=>{createIdCache(this);});}}
